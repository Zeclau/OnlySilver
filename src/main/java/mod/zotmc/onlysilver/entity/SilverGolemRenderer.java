...
public class SilverGolemRenderer extends MobRenderer<SilverGolemEntity, SilverGolemModel>
{
    ...
    @Override
    protected void applyRotations(SilverGolemEntity entityLiving, float ageInTicks,
    ...
    @Override
    protected void preRenderCallback(SilverGolemEntity entitylivingbaseIn, float partialTickTime)
    {
    	GlStateManager.scalef(8/14f, 19/29f, 8/14f);
    }
